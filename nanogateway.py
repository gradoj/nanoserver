...
from nanoserver import localPush, localPull, commitNV
        ...
        while not self.udp_stop:
            try:
                ...
                if _type == PUSH_ACK:
                    ...
                    #self._log('udpdata: {}', tx_pk)
                    #print('txpkfreqtype',type(tx_pk["txpk"]["freq"]),tx_pk["txpk"]["freq"])
                    #print('txpktmsttype',type(tx_pk["txpk"]["tmst"]),tx_pk["txpk"]["tmst"])
                    #print('txpkdatrtype',type(tx_pk["txpk"]["datr"]),tx_pk["txpk"]["datr"])
